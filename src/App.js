      ...
      <div className="App">
        <div className={"leftPortion"}>
          <div className="leftTextContainer">
            ...
            <div className={"showInfoBody"}>Submit your work for the IDM 2020 Virtual Spring Showcase! The showcase is an opportunity for students to receive a public platform to share all of the incredible projects you’ve been working on. Through live screenings, social media, and our showcase site, this show will be a public-facing exhibition and celebration of the hard work IDM students have put in this year. Apply for a spot in the showcase by 04/24th </div>
